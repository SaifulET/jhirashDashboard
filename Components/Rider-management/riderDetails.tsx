        ...
        <div className="">
          <div className="flex items-center justify-between p-6 ">
            <div className="flex items-center gap-4">
              <Link href='/pages/rider-management'><button className="p-2 bg-[#A6AFFF] hover:bg-[#97a0f5] text-gray-900 rounded-lg transition-colors">
                  ...
                  <div key={ride.id} className="bg-[#F4F4F6] rounded-lg p-5">
                    ...
                    <div className="flex items-center justify-between mb-4 gap-[20px]">
                      <div className="gap-1 text-gray-700 bg-white px-[38px] py-[6px] rounded-lg">
                        <div className='flex'><HugeiconsIcon icon={Money04Icon} className='text-[#047049]'/>
                        <span className="font-semibold  ml-[10px]">{ride.fare}</span></div>
                       <div> <span className="text-xs flex justify-center text-center text-gray-500 ml-1">FARE</span></div>
                      </div>
                      <div className=" gap-1 text-gray-700 bg-white px-[38px] py-[6px] rounded-lg">
                       <div className='flex'> <Star className="w-4 h-4 text-[#E9A906] fill-[#E9A906]" />
                        <span className="font-semibold ml-[10px]">{ride.rating}</span></div>
                       <div> <span className="text-xs text-gray-500 ml-1 text-center">RATING</span></div>
                      </div>
                    </div>

                    <Link href="/pages/rider-management/dkd/23"><button className="w-full py-2.5 bg-[#A6AFFF] hover:bg-[#97a0f5] text-gray-900 font-medium rounded-lg transition-colors">
                      View
                    </button></Link>
                  </div>
                ))}
