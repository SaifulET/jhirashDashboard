              ...
              <div className="grid grid-cols-3 gap-6">
                {historyData.map((ride) => (
                  <div key={ride.id} className="bg-[#F4F4F6] rounded-lg p-5">
                    ...
                    <Link href="/pages/driver-management/dkd/23"><button className="w-full py-2.5 bg-[#A6AFFF] hover:bg-[#97a0f5] text-gray-900 font-medium rounded-lg transition-colors">
                      View
                    </button></Link>
                  </div>
                ))}
